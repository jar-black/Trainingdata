#!/usr/bin/env python3
"""
Manual poem collection helper for Viktor Rydberg poems.
...
Usage:
    ...
    python3 scripts/collect_rydberg_poems.py --output-dir poems/rydberg
    python3 scripts/collect_rydberg_poems.py --resume
...
class RydbergPoemCollector:
    def __init__(self, output_dir="poems/rydberg", jsonl_path="data/rydberg_poems.jsonl", template_path="data/rydberg_poems_template.jsonl"):
    ...
    def show_progress(self):
        ...
        print("\n" + "="*60)
        print("VIKTOR RYDBERG POEM COLLECTION PROGRESS")
        print("="*60)
    ...
    def run_interactive_session(self):
        ...
        print("\n" + "="*60)
        print("VIKTOR RYDBERG POEM COLLECTOR")
        print("="*60)
        print("\nThis tool helps you manually collect Viktor Rydberg's poems")
        print("with both Swedish originals and English translations.")
        print("\nSources:")
        print("  Swedish: https://runeberg.org/rydbdikt/")
        print("  English: Anthology of Swedish Lyrics (1917)")
        print("           https://archive.org/details/anthologyofswedi00stor")
        print("\nFormat: poemN-swedish.txt, poemN-english.txt\n")
        ...
        self.show_progress()
        print("Thank you for collecting Viktor Rydberg poems!")
        print("="*60 + "\n")

def main():
    import argparse

    parser = argparse.ArgumentParser(description='Viktor Rydberg poem collection helper')
    parser.add_argument('--output-dir', default='poems/rydberg', help='Output directory for poem files')
    parser.add_argument('--resume', action='store_true', help='Resume collection session')
    parser.add_argument('--stats', action='store_true', help='Show statistics only')

    args = parser.parse_args()

    collector = RydbergPoemCollector(output_dir=args.output_dir)
